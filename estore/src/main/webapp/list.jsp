<%@ page import="com.briup.bean.Book" %>
...
<html>
    ...
    <div class="container4">
        ...
        <div class="c4_b2">
            <h1 class="c4_b2_x">
                <a href="#">计算机类&nbsp;&nbsp;></a>
                <span><a href="ListBookByCategory?idCate=${bookByCategory[0].category.id }">${bookByCategory[0].description }</a></span>
            </h1>
        ...
        <div class="c4_b5">
            <div class="c4_b5_content">
                <ul class="c4_b5_c_boxes">
                    <c:forEach items="${bookByCategory }" var="book">
                        <li class="c4_b5_c_box">
                            <!--图片-->
                            <div class="c4_b5_c_box_pic">
                                <div class="c4b5_pic_view">
                                    <a href="BookById?idView=${book.id }"><img src="${book.image }"></a>
                                </div>
                            </div>
                            <!--价钱-->
                            <div class="c4_b5_c_box_txt">
                                <h1>¥${book.price }</h1>
                                <h2><a href="BookById?idView=${book.id }">${book.name }</a></h2>
                            </div>
                            <!--购买等操作-->
                            <div class="c4b5_el">
                                <div class="c4b5_el_x">
                            ...
                            <ul class="c4b5_option">
                                <li class="shopcar_box"><span class="shopcar01"></span><a href="shopCar.jsp">加入购物车</a></li>
                            </ul>
                        </li>
                    </c:forEach>
                </ul>
